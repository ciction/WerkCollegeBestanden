...
public class ScrollableTest {
	...
	//Components
	JButton buttonTest;	
	CreateQuestionListener myListener;
	...
	public CreateQuestionListener getMyListener() {
		return myListener;
	}
	public void setMyListener(CreateQuestionListener myListener) {
	...
	public ScrollableTest() {
		...
		myListener = new CreateQuestionListener(this);
	...
	public void addUIQuestion(){
		...
		JpanelTest newElement = new JpanelTest(WINDOW_WIDTH, currentColor);
